...
// Nếu temp bằng quản lí danh mục sẽ chuyển tới các trang xử lí 
 ...
 //thongtintaikhoan
 elseif ($temp=='thongtintaikhoan' && $query =='them') {
   
  include("thongtintaikhoan/lietke.php");
  
}elseif ($temp=='thongtintaikhoan' && $query =='sua') {
  
    include("thongtintaikhoan/sua.php");
} 

//thongtinphongban
elseif ($temp=='thongtinphongban' && $query =='them') {
   
    include("thongtinphongban/lietke.php");
    
  }elseif ($temp=='thongtinphongban' && $query =='sua') {
    
      include("thongtinphongban/sua.php");
  } 
