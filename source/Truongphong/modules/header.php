...
<div id="header">
  ...
  <div class="container-fluid">
    <a class="navbar-brand" href="index.php">Truongphong
    <div class="row">
    ...
    <div class="collapse navbar-collapse" id="navbarResponsive">
      ...
      <ul class="navbar-nav ml-auto">
        ...
        <li class="nav-item">
         ...
         <li class="nav-item">
         <a href="index.php?action=quanlitaikhoan&query=them">Xem danh sách task </a>
        </li>
         
        <li class="nav-item">
        <a href="index.php?action=quanliphongban&query=them">Xem thông tin ngày nghỉ phép </a>
        </li>
