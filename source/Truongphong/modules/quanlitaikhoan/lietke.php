 ...
 <td><?php echo $row['thongtin'] ?></td>
    ...
    <td>
      <a href="modules/quanlitaikhoan/xuly.php?ma_task=<?php echo $row['ma_task']?> ">Xóa<br></a> 
        ...
        <a href="modules/quanlitaikhoan/xuly.php?ma_task=<?php echo $row['ma_task']?> ">Reject</a>
        <a href="modules/quanlitaikhoan/xuly.php?ma_task=<?php echo $row['ma_task']?> ">Approve</a>
    </td>
